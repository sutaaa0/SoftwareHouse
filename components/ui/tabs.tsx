...
export const Tabs = ({
  ...
  return (
    <>
      <div className={cn("flex flex-row flex-wrap items-center  lg:h-auto h-[110px] justify-center [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full w-full", containerClassName)}>
        {propTabs.map((tab, idx) => (
          ...
          >
            ...
            <span className="relative  block text-black dark:text-white text-sm lg:text-base">{tab.title}</span>
          </button>
        ))}
      </div>
